                    ...
                    <form method="get" action="{{ route('user.create') }}">
                        ...
                        <div class="form-group row col-sm-12">
                            <label class=" "><b>Nome</b></label>
                                <input type="text" class="input_login" id="input_password" name="name"
                        ...
                        <div class="form-group row col-sm-12">
                            <label for="" class=""><b>Senha</b></label>
                                <input type="password" class="input_login" id="input_password"
                                    name="password" placeholder="Digite sua Senha" required>
                        </div>
                        <div class="form-group row col-sm-12">
                            <label for="" class=""><b>Confirmação de Senha</b></label>
                                <input type="password" class="input_login" id="input_password"
                                    name="password" placeholder="Digite novamente sua senha" required>
                        </div>
                        <div class="form-group row col-sm-12">
