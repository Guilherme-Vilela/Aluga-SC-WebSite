...
@section('content')
                                ...
                                <div class="col-12 d-flex align-items-center" style="height:70vh;">
                                    <div class="row ">
                                        <div class="col-12 d-flex justify-content-center m-2">
                                            ...
                                            <input type="text" id="name_immobile" class="form-control" value = "{{$immobile->name}}">
                                        </div>
                                        <div class="col-12 d-flex justify-content-center m-2">
                                            <label>Valor cobrado por noite</label>
                                            <input type="text" id="value_immobile" class="form-control" value = "{{$immobile->value}}">
                                        </div>
                                        <div class="col-12 d-flex justify-content-center m-2">
                                            <label>Quantidade de quartos</label>
                                            <input type="text" id="bedrooms_immobile" class="form-control" value = "{{$immobile->name}}">
                                        </div>
                                        <div class="col-12 d-flex justify-content-center m-2">
                                            <label>Quantidade de banheiros</label>
                                            <input type="text" id="bathrooms_immobile" class="form-control" value = "{{$immobile->name}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @if (isset($immobile))
        <script>
            $(document).ready(function() {
                 $(".button_selection_type_immobile").each(function() {
                    if ( $(this).attr('value') == "{{ $immobile->type }}") {
                        $(this).css("background", "#ccc");
                        let type_immobile = ['type', $(this).attr("value")];
                        array_immobile[0] = (type_immobile);
                        $(this).css("background", "#ccc");
